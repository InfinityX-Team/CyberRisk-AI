    ...
    <div>
      <nav className="flex items-center justify-between px-10 py-4 border-b bg-white">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="font-bold text-lg leading-none">CyberRisk AI</div>
        ...
        <div className="grid grid-cols-2 gap-10 items-start max-w-6xl mx-auto">
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Move beyond Low/Medium/High labels. CyberRisk AI continuously calculates Expected Annual Loss,
